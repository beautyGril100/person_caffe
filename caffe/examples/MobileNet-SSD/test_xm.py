...
net_file= './xm/deploy.prototxt'  
caffe_model='./xm/deploy.caffemodel'  
test_dir = "xm"
...
def detect(imgfile):
    ...
    for layer_name, blob in net.blobs.items():
      ...
      np.savetxt('xm/temp/'+layer_name_modify+'.txt',blob_1d,fmt="%.5f", delimiter="\n")
