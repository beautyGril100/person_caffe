...
net_file= './xiaomeng/FPN1_82_2.prototxt'  
caffe_model='./xiaomeng/deploy.caffemodel'  
test_dir = "xiaomeng"
...
def detect(imgfile):
    ...
    net.blobs['data_original'].data[...] = img
    out = net.forward()  
    ...
    for layer_name, blob in net.blobs.items():
      ...
      np.savetxt('xiaomeng/temp/'+layer_name+'.txt',blob_1d,fmt="%.5f", delimiter="\n")
