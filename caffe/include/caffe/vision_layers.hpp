...
template <typename Dtype>
class CAROIPoolingLayer : public Layer<Dtype> {
 public:
  explicit CAROIPoolingLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "CAROIPooling"; }
 ...
 protected:
  ...
  Dtype pad_ratio_;
  Blob<int> max_idx_;
  //const vector<Blob<Dtype>*>& top_all_;
};


//HU Xiaowei @The Chinese University of Hong Kong
template <typename Dtype>
class ROICountLayer : public Layer<Dtype> {
 public:
  explicit ROICountLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "ROICount"; }
...
//HU Xiaowei @The Chinese University of Hong Kong
template <typename Dtype>
class ROISplitLayer : public Layer<Dtype> {
 public:
  explicit ROISplitLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "ROISplit"; }
 ...
 protected:
  ...
  int split_area1_;
  int split_area2_;
  int fluctuation_range_large_;
  int fluctuation_range_small_;
};


//HU Xiaowei @The Chinese University of Hong Kong
template <typename Dtype>
class CAROIPooling2Layer : public Layer<Dtype> {
 public:
  explicit CAROIPooling2Layer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "CAROIPooling2"; }
 ...
 protected:
  ...
  int pooled_width_;
  Dtype spatial_scale_;
  Dtype pad_ratio_normal_;
  Dtype pad_ratio_small_;
  Blob<int> max_idx_;
  int small_roi_;
  bool small_roi_zero;
  bool normal_roi_zero;
  bool normal_branch_;
  bool small_branch_;
  //const vector<Blob<Dtype>*>& top_all_;
};
...
class UpsampleLayer : public Layer<Dtype> {
 public:
  ...
  //virtual inline int ExactNumBottomBlobs() const { return 2; }  //commented by hwzhu
  virtual inline int ExactNumTopBlobs() const { return 1; }
 ...
 protected:
  ...
  bool only_one_bottom_blob_flag;
  int scale_;
  /*******************added by hwzhu end************************/
};
