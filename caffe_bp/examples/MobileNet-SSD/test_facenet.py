...
net_file= './facenet/deploy.prototxt'  
caffe_model='./facenet/deploy.caffemodel'  
test_dir = "images_jd"
...
def detect(imgfile):
    ...
    for layer_name, blob in net.blobs.items():
      ...
      np.savetxt('facenet/temp/'+layer_name+'.txt',blob_1d,fmt="%.5f", delimiter="\n")
...
for index in range(0,1):
    img_path = "facenet/image/5a9b9ee9N199298c7.jpg"
