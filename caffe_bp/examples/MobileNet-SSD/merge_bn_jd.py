...
train_proto = 'MSSD_jd/deploy_nomerge.prototxt'  
train_model = 'MSSD_jd/deploy_nomerge.caffemodel'  #should be your snapshot caffemodel

deploy_proto = 'MSSD_jd/deploy.prototxt'  
save_model = 'MSSD_jd/deploy.caffemodel'
