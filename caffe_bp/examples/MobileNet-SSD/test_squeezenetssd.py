...
net_file= './squeezenetssd/deploy.prototxt'  
caffe_model='./squeezenetssd/deploy.caffemodel'  
test_dir = "images_squeezenetssd"
...
def detect(imgfile):
    ...
    for layer_name, blob in net.blobs.items():
      ...
      np.savetxt('ruiwei/temp/'+layer_name+'.txt',blob_1d,fmt="%.5f", delimiter="\n")
