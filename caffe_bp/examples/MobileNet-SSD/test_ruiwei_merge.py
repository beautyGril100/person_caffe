...
net_file= './ruiwei/mobilenet_ssd_ruiwei_320_570/deploy_merge.prototxt'  
caffe_model='./ruiwei/mobilenet_ssd_ruiwei_320_570/deploy_merge.caffemodel'  
test_dir = "images_jd"
...
def detect(imgfile):
    ...
    for layer_name, blob in net.blobs.items():
      ...
      np.savetxt('ruiwei/temp_merge/'+layer_name+'.txt',blob_1d,fmt="%.5f", delimiter="\n")
    
   # mbox_priorbox = out['mbox_priorbox']
    
    detection_out = out['detection_out_frontal_face']
